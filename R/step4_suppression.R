...
secondary_sup = function(data_qtrly, data_annual){
  ...
  while (!finished) {
    ...
    for (level in 5:2) {
      ...
      data_qtrly[match(qtrly_total$industry_code,
                       data_qtrly$industry_code),] = 
        qtrly_total
      data_qtrly[match(qtrly_detail$industry_code,
                       data_qtrly$industry_code),] = 
        qtrly_detail
      data_annual[match(annual_total$industry_code,
                        data_annual$industry_code),] = 
        annual_total
      data_annual[match(annual_detail$industry_code,
                        data_annual$industry_code),] = 
        annual_detail
    }
